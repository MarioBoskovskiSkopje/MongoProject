...
module.exports = {
    ...
    update: function (req, res) {
        ...
        OrdersModel.findOne({_id: id}, function (err, Orders) {
			...
			Orders.backtubed = req.body.backtubed ? req.body.backtubed : Orders.backtubed;
			...
			Orders.botlabelsku = req.body.botlabelsku ? req.body.botlabelsku : Orders.botlabelsku;
			...
			Orders.CBDrecipe = req.body.CBDrecipe ? req.body.CBDrecipe : Orders.CBDrecipe;
			Orders.CBDvalue = req.body.CBDvalue ? req.body.CBDvalue : Orders.CBDvalue;
			Orders.coloredpremix = req.body.coloredpremix ? req.body.coloredpremix : Orders.coloredpremix;
			Orders.CompletionDate = req.body.CompletionDate ? req.body.CompletionDate : Orders.CompletionDate;
			Orders.customer = req.body.customer ? req.body.customer : Orders.customer;
			Orders.customerSKU = req.body.customerSKU ? req.body.customerSKU : Orders.customerSKU;
			Orders.dateshipped = req.body.dateshipped ? req.body.dateshipped : Orders.dateshipped;
			Orders.fill = req.body.fill ? req.body.fill : Orders.fill;
			Orders.final_status = req.body.final_status ? req.body.final_status : Orders.final_status;
			Orders.flavour = req.body.flavour ? req.body.flavour : Orders.flavour;
			Orders.flavrecipe = req.body.flavrecipe ? req.body.flavrecipe : Orders.flavrecipe;
			Orders.flavvalue = req.body.flavvalue ? req.body.flavvalue : Orders.flavvalue;
			Orders.labeling_status = req.body.labeling_status ? req.body.labeling_status : Orders.labeling_status;
			Orders.lid = req.body.lid ? req.body.lid : Orders.lid;
			Orders.lidSKU = req.body.lidSKU ? req.body.lidSKU : Orders.lidSKU;
			Orders.MCTrecipe = req.body.MCTrecipe ? req.body.MCTrecipe : Orders.MCTrecipe;
			Orders.MCTval = req.body.MCTval ? req.body.MCTval : Orders.MCTval;
			Orders.mixing = req.body.mixing ? req.body.mixing : Orders.mixing;
			Orders.mixing_status = req.body.mixing_status ? req.body.mixing_status : Orders.mixing_status;
			Orders.NIB = req.body.NIB ? req.body.NIB : Orders.NIB;
			Orders.Nico = req.body.Nico ? req.body.Nico : Orders.Nico;
			Orders.Nicotrecipe = req.body.Nicotrecipe ? req.body.Nicotrecipe : Orders.Nicotrecipe;
			Orders.Nicotrecipesalts = req.body.Nicotrecipesalts ? req.body.Nicotrecipesalts : Orders.Nicotrecipesalts;
			...
			Orders.packaging_status = req.body.packaging_status ? req.body.packaging_status : Orders.packaging_status;
			Orders.packagingType = req.body.packagingType ? req.body.packagingType : Orders.packagingType;
			Orders.packlabel = req.body.packlabel ? req.body.packlabel : Orders.packlabel;
			Orders.packlabelsku = req.body.packlabelsku ? req.body.packlabelsku : Orders.packlabelsku;
			Orders.partialPackaging = req.body.partialPackaging ? req.body.partialPackaging : Orders.partialPackaging;
			Orders.partialProduction = req.body.partialProduction ? req.body.partialProduction : Orders.partialProduction;
			...
			Orders.PRINTCODE = req.body.PRINTCODE ? req.body.PRINTCODE : Orders.PRINTCODE;
			Orders.printing_status = req.body.printing_status ? req.body.printing_status : Orders.printing_status;
			Orders.priority = req.body.priority ? req.body.priority : Orders.priority;
			Orders.productcode = req.body.productcode ? req.body.productcode : Orders.productcode;
			Orders.productdescription = req.body.productdescription ? req.body.productdescription : Orders.productdescription;
			Orders.production_status = req.body.production_status ? req.body.production_status : Orders.production_status;
			Orders.QTY = req.body.QTY ? req.body.QTY : Orders.QTY;
			Orders.recipe = req.body.recipe ? req.body.recipe : Orders.recipe;
			Orders.removedPackaging = req.body.removedPackaging ? req.body.removedPackaging : Orders.removedPackaging;
			Orders.removedProduction = req.body.removedProduction ? req.body.removedProduction : Orders.removedProduction;
			...
			Orders.shipping_status = req.body.shipping_status ? req.body.shipping_status : Orders.shipping_status;
			Orders.SHIPPINGCODE = req.body.SHIPPINGCODE ? req.body.SHIPPINGCODE : Orders.SHIPPINGCODE;
			Orders.stocking = req.body.stocking ? req.body.stocking : Orders.stocking;
			Orders.unbranded = req.body.unbranded ? req.body.unbranded : Orders.unbranded;
			...
			Orders.wentNegative = req.body.wentNegative ? req.body.wentNegative : Orders.wentNegative;
