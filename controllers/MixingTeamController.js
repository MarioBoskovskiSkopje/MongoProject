...
module.exports = {
  ...
  show: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.MixingTeam] = id;
    MixingTeamModel.findOne(obj, function(err, MixingTeam) {
      if (err) {
        return res.status(500).json({
          message: "Error when getting MixingTeam.",
          error: err
  ...
  update: function(req, res) {
    ...
    MixingTeamModel.findOne(obj, function(err, MixingTeam) {
      ...
      MixingTeam.Batches = req.body.Batches
        ? req.body.Batches
        : MixingTeam.Batches;
      MixingTeam.CBDvalue = req.body.CBDvalue
        ? req.body.CBDvalue
        : MixingTeam.CBDvalue;
      MixingTeam.Completed = req.body.Completed
        ? req.body.Completed
        : MixingTeam.Completed;
      MixingTeam.CompletionDate = req.body.CompletionDate
        ? req.body.CompletionDate
        : MixingTeam.CompletionDate;
      MixingTeam.customer = req.body.customer
        ? req.body.customer
        : MixingTeam.customer;
      MixingTeam.flavour = req.body.flavour
        ? req.body.flavour
        : MixingTeam.flavour;
      MixingTeam.FLAVOUR = req.body.FLAVOUR
        ? req.body.FLAVOUR
        : MixingTeam.FLAVOUR;
      MixingTeam.flavSupplier = req.body.flavSupplier
        ? req.body.flavSupplier
        : MixingTeam.flavSupplier;
      MixingTeam.flavvalue = req.body.flavvalue
        ? req.body.flavvalue
        : MixingTeam.flavvalue;
      MixingTeam.Location = req.body.Location
        ? req.body.Location
        : MixingTeam.Location;
      MixingTeam.MIXNAME = req.body.MIXNAME
        ? req.body.MIXNAME
        : MixingTeam.MIXNAME;
      MixingTeam.movedtoNext = req.body.movedtoNext
        ? req.body.movedtoNext
        : MixingTeam.movedtoNext;
      MixingTeam.Nico = req.body.Nico ? req.body.Nico : MixingTeam.Nico;
      MixingTeam.nicSupplier = req.body.nicSupplier
        ? req.body.nicSupplier
        : MixingTeam.nicSupplier;
      MixingTeam.Notes = req.body.Notes ? req.body.Notes : MixingTeam.Notes;
      MixingTeam.orderdate = req.body.orderdate
        ? req.body.orderdate
        : MixingTeam.orderdate;
      MixingTeam.orderID = req.body.orderID
        ? req.body.orderID
        : MixingTeam.orderID;
      MixingTeam.pgSupplier = req.body.pgSupplier
        ? req.body.pgSupplier
        : MixingTeam.pgSupplier;
      MixingTeam.PGval = req.body.PGval ? req.body.PGval : MixingTeam.PGval;
      MixingTeam.prodDate = req.body.prodDate
        ? req.body.prodDate
        : MixingTeam.prodDate;
      MixingTeam.QTYTOTAL = req.body.QTYTOTAL
        ? req.body.QTYTOTAL
        : MixingTeam.QTYTOTAL;
      ...
      MixingTeam.starttime = req.body.starttime
        ? req.body.starttime
        : MixingTeam.starttime;
      MixingTeam.userset = req.body.userset
        ? req.body.userset
        : MixingTeam.userset;
      MixingTeam.vgSupplier = req.body.vgSupplier
        ? req.body.vgSupplier
        : MixingTeam.vgSupplier;
  ...
  remove: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.MixingTeam] = id;
    MixingTeamModel.findOneAndRemove(obj, function(err, MixingTeam) {
      if (err) {
        return res.status(500).json({
