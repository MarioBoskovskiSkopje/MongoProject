...
module.exports = {
    ...
    update: function (req, res) {
        ...
        MixingModel.findOne({_id: id}, function (err, Mixing) {
			...
			Mixing.CBDrecipe = req.body.CBDrecipe ? req.body.CBDrecipe : Mixing.CBDrecipe;
			Mixing.CBDvalue = req.body.CBDvalue ? req.body.CBDvalue : Mixing.CBDvalue;
			Mixing.Completed = req.body.Completed ? req.body.Completed : Mixing.Completed;
			Mixing.CompletionDate = req.body.CompletionDate ? req.body.CompletionDate : Mixing.CompletionDate;
			Mixing.Location = req.body.Location ? req.body.Location : Mixing.Location;
			Mixing.MCTrecipe = req.body.MCTrecipe ? req.body.MCTrecipe : Mixing.MCTrecipe;
			Mixing.MCTval = req.body.MCTval ? req.body.MCTval : Mixing.MCTval;
			Mixing.Nico = req.body.Nico ? req.body.Nico : Mixing.Nico;
			Mixing.Nicotrecipe = req.body.Nicotrecipe ? req.body.Nicotrecipe : Mixing.Nicotrecipe;
			Mixing.Nicotrecipesalts = req.body.Nicotrecipesalts ? req.body.Nicotrecipesalts : Mixing.Nicotrecipesalts;
			...
			Mixing.backtubed = req.body.backtubed ? req.body.backtubed : Mixing.backtubed;
			...
			Mixing.final_status = req.body.final_status ? req.body.final_status : Mixing.final_status;
			Mixing.flavour = req.body.flavour ? req.body.flavour : Mixing.flavour;
			Mixing.flavrecipe = req.body.flavrecipe ? req.body.flavrecipe : Mixing.flavrecipe;
			Mixing.flavvalue = req.body.flavvalue ? req.body.flavvalue : Mixing.flavvalue;
			Mixing.haspremix = req.body.haspremix ? req.body.haspremix : Mixing.haspremix;
			Mixing.labeling_status = req.body.labeling_status ? req.body.labeling_status : Mixing.labeling_status;
			Mixing.mixing = req.body.mixing ? req.body.mixing : Mixing.mixing;
			Mixing.mixing_status = req.body.mixing_status ? req.body.mixing_status : Mixing.mixing_status;
			Mixing.movedtoNext = req.body.movedtoNext ? req.body.movedtoNext : Mixing.movedtoNext;
			...
			Mixing.orderdate = req.body.orderdate ? req.body.orderdate : Mixing.orderdate;
			Mixing.packaging_status = req.body.packaging_status ? req.body.packaging_status : Mixing.packaging_status;
			Mixing.premixed = req.body.premixed ? req.body.premixed : Mixing.premixed;
			Mixing.printing_status = req.body.printing_status ? req.body.printing_status : Mixing.printing_status;
			Mixing.productcode = req.body.productcode ? req.body.productcode : Mixing.productcode;
			Mixing.productdescription = req.body.productdescription ? req.body.productdescription : Mixing.productdescription;
			...
			Mixing.starttime = req.body.starttime ? req.body.starttime : Mixing.starttime;
			Mixing.unbranded = req.body.unbranded ? req.body.unbranded : Mixing.unbranded;
