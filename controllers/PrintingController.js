...
module.exports = {
  ...
  show: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.Printing] = id;
    PrintingModel.findOne(obj, function(err, Printing) {
      if (err) {
        return res.status(500).json({
          message: "Error when getting Printing.",
          error: err
  ...
  update: function(req, res) {
    ...
    PrintingModel.findOne(obj, function(err, Printing) {
      ...
      Printing.backtubed = req.body.backtubed
        ? req.body.backtubed
        : Printing.backtubed;
      Printing.batch = req.body.batch ? req.body.batch : Printing.batch;
      Printing.botlabel = req.body.botlabel
        ? req.body.botlabel
        : Printing.botlabel;
      Printing.botlabelsku = req.body.botlabelsku
        ? req.body.botlabelsku
        : Printing.botlabelsku;
      ...
      Printing.brandSKU = req.body.brandSKU
        ? req.body.brandSKU
        : Printing.brandSKU;
      Printing.bsize = req.body.bsize ? req.body.bsize : Printing.bsize;
      Printing.btype = req.body.btype ? req.body.btype : Printing.btype;
      Printing.Completed = req.body.Completed
        ? req.body.Completed
        : Printing.Completed;
      Printing.CompletionDate = req.body.CompletionDate
        ? req.body.CompletionDate
        : Printing.CompletionDate;
      Printing.customer = req.body.customer
        ? req.body.customer
        : Printing.customer;
      Printing.customerSKU = req.body.customerSKU
        ? req.body.customerSKU
        : Printing.customerSKU;
      Printing.final_status = req.body.final_status
        ? req.body.final_status
        : Printing.final_status;
      Printing.flavour = req.body.flavour ? req.body.flavour : Printing.flavour;
      Printing.labeling_status = req.body.labeling_status
        ? req.body.labeling_status
        : Printing.labeling_status;
      Printing.lid = req.body.lid ? req.body.lid : Printing.lid;
      Printing.lidSKU = req.body.lidSKU ? req.body.lidSKU : Printing.lidSKU;
      Printing.Location = req.body.Location
        ? req.body.Location
        : Printing.Location;
      Printing.mixing = req.body.mixing ? req.body.mixing : Printing.mixing;
      Printing.mixing_status = req.body.mixing_status
        ? req.body.mixing_status
        : Printing.mixing_status;
      Printing.movedtoNext = req.body.movedtoNext
        ? req.body.movedtoNext
        : Printing.movedtoNext;
      Printing.numLabelsBottles = req.body.numLabelsBottles
        ? req.body.numLabelsBottles
        : Printing.numLabelsBottles;
      Printing.numLabelsTubes = req.body.numLabelsTubes
        ? req.body.numLabelsTubes
        : Printing.numLabelsTubes;
      Printing.orderdate = req.body.orderdate
        ? req.body.orderdate
        : Printing.orderdate;
      Printing.orderID = req.body.orderID ? req.body.orderID : Printing.orderID;
      Printing.packaging_status = req.body.packaging_status
        ? req.body.packaging_status
        : Printing.packaging_status;
      Printing.packagingType = req.body.packagingType
        ? req.body.packagingType
        : Printing.packagingType;
      Printing.packlabel = req.body.packlabel
        ? req.body.packlabel
        : Printing.packlabel;
      Printing.packlabelsku = req.body.packlabelsku
        ? req.body.packlabelsku
        : Printing.packlabelsku;
      ...
      Printing.printing_status = req.body.printing_status
        ? req.body.printing_status
        : Printing.printing_status;
      Printing.productcode = req.body.productcode
        ? req.body.productcode
        : Printing.productcode;
      Printing.productdescription = req.body.productdescription
        ? req.body.productdescription
        : Printing.productdescription;
      Printing.ProductionCompleted = req.body.ProductionCompleted
        ? req.body.ProductionCompleted
        : Printing.ProductionCompleted;
      Printing.recipe = req.body.recipe ? req.body.recipe : Printing.recipe;
      Printing.row = req.body.row ? req.body.row : Printing.row;
      Printing.starttime = req.body.starttime
        ? req.body.starttime
        : Printing.starttime;
      Printing.unbranded = req.body.unbranded
        ? req.body.unbranded
        : Printing.unbranded;
  ...
  remove: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.Printing] = id;
    PrintingModel.findOneAndRemove(obj, function(err, Printing) {
      if (err) {
        return res.status(500).json({
