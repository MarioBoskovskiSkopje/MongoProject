...
module.exports = {
  ...
  show: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.Labelling] = id;
    LabellingModel.findOne(obj, function(err, Labelling) {
      if (err) {
        return res.status(500).json({
          message: "Error when getting Labelling.",
          error: err
  ...
  update: function(req, res) {
    ...
    LabellingModel.findOne(obj, function(err, Labelling) {
      ...
      Labelling.backtubed = req.body.backtubed
        ? req.body.backtubed
        : Labelling.backtubed;
      Labelling.batch = req.body.batch ? req.body.batch : Labelling.batch;
      Labelling.botlabel = req.body.botlabel
        ? req.body.botlabel
        : Labelling.botlabel;
      Labelling.botlabelsku = req.body.botlabelsku
        ? req.body.botlabelsku
        : Labelling.botlabelsku;
      Labelling.botSKU = req.body.botSKU ? req.body.botSKU : Labelling.botSKU;
      Labelling.bottles = req.body.bottles
        ? req.body.bottles
        : Labelling.bottles;
      Labelling.boxname = req.body.boxname
        ? req.body.boxname
        : Labelling.boxname;
      Labelling.brand = req.body.brand ? req.body.brand : Labelling.brand;
      Labelling.branded = req.body.branded
        ? req.body.branded
        : Labelling.branded;
      Labelling.brandSKU = req.body.brandSKU
        ? req.body.brandSKU
        : Labelling.brandSKU;
      ...
      Labelling.Completed = req.body.Completed
        ? req.body.Completed
        : Labelling.Completed;
      Labelling.CompletionDate = req.body.CompletionDate
        ? req.body.CompletionDate
        : Labelling.CompletionDate;
      Labelling.customer = req.body.customer
        ? req.body.customer
        : Labelling.customer;
      Labelling.customerSKU = req.body.customerSKU
        ? req.body.customerSKU
        : Labelling.customerSKU;
      Labelling.final_status = req.body.final_status
        ? req.body.final_status
        : Labelling.final_status;
      Labelling.flavour = req.body.flavour
        ? req.body.flavour
        : Labelling.flavour;
      Labelling.labeling_status = req.body.labeling_status
        ? req.body.labeling_status
        : Labelling.labeling_status;
      Labelling.lid = req.body.lid ? req.body.lid : Labelling.lid;
      Labelling.lidSKU = req.body.lidSKU ? req.body.lidSKU : Labelling.lidSKU;
      Labelling.Location = req.body.Location
        ? req.body.Location
        : Labelling.Location;
      Labelling.mixing = req.body.mixing ? req.body.mixing : Labelling.mixing;
      Labelling.mixing_status = req.body.mixing_status
        ? req.body.mixing_status
        : Labelling.mixing_status;
      Labelling.movedtoNext = req.body.movedtoNext
        ? req.body.movedtoNext
        : Labelling.movedtoNext;
      Labelling.numLabelsBottles = req.body.numLabelsBottles
        ? req.body.numLabelsBottles
        : Labelling.numLabelsBottles;
      Labelling.numLabelsTubes = req.body.numLabelsTubes
        ? req.body.numLabelsTubes
        : Labelling.numLabelsTubes;
      Labelling.orderdate = req.body.orderdate
        ? req.body.orderdate
        : Labelling.orderdate;
      Labelling.orderID = req.body.orderID
        ? req.body.orderID
        : Labelling.orderID;
      Labelling.packaging_status = req.body.packaging_status
        ? req.body.packaging_status
        : Labelling.packaging_status;
      Labelling.packagingType = req.body.packagingType
        ? req.body.packagingType
        : Labelling.packagingType;
      Labelling.packlabel = req.body.packlabel
        ? req.body.packlabel
        : Labelling.packlabel;
      Labelling.packlabelsku = req.body.packlabelsku
        ? req.body.packlabelsku
        : Labelling.packlabelsku;
      Labelling.ppb = req.body.ppb ? req.body.ppb : Labelling.ppb;
      Labelling.ppp = req.body.ppp ? req.body.ppp : Labelling.ppp;
      Labelling.premixed = req.body.premixed
        ? req.body.premixed
        : Labelling.premixed;
      Labelling.printing_status = req.body.printing_status
        ? req.body.printing_status
        : Labelling.printing_status;
      Labelling.productcode = req.body.productcode
        ? req.body.productcode
        : Labelling.productcode;
      Labelling.productdescription = req.body.productdescription
        ? req.body.productdescription
        : Labelling.productdescription;
      Labelling.ProductionCompleted = req.body.ProductionCompleted
        ? req.body.ProductionCompleted
        : Labelling.ProductionCompleted;
      Labelling.recipe = req.body.recipe ? req.body.recipe : Labelling.recipe;
      Labelling.row = req.body.row ? req.body.row : Labelling.row;
      Labelling.starttime = req.body.starttime
        ? req.body.starttime
        : Labelling.starttime;
      Labelling.unbranded = req.body.unbranded
        ? req.body.unbranded
        : Labelling.unbranded;
      Labelling.userset = req.body.userset
        ? req.body.userset
        : Labelling.userset;
  ...
  remove: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.Labelling] = id;
    LabellingModel.findOneAndRemove(obj, function(err, Labelling) {
      if (err) {
        return res.status(500).json({
