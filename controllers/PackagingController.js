...
module.exports = {
  ...
  show: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.Packaging] = id;
    PackagingModel.findOne(obj, function(err, Packaging) {
      if (err) {
        return res.status(500).json({
          message: "Error when getting Packaging.",
          error: err
  ...
  update: function(req, res) {
    ...
    PackagingModel.findOne(obj, function(err, Packaging) {
      ...
      Packaging.Completed = req.body.Completed
        ? req.body.Completed
        : Packaging.Completed;
      Packaging.CompletionDate = req.body.CompletionDate
        ? req.body.CompletionDate
        : Packaging.CompletionDate;
      Packaging.Location = req.body.Location
        ? req.body.Location
        : Packaging.Location;
      Packaging.PackagingCompleted = req.body.PackagingCompleted
        ? req.body.PackagingCompleted
        : Packaging.PackagingCompleted;
      Packaging.ProductionCompleted = req.body.ProductionCompleted
        ? req.body.ProductionCompleted
        : Packaging.ProductionCompleted;
      Packaging.backtubed = req.body.backtubed
        ? req.body.backtubed
        : Packaging.backtubed;
      ...
      Packaging.botlabel = req.body.botlabel
        ? req.body.botlabel
        : Packaging.botlabel;
      Packaging.botlabelsku = req.body.botlabelsku
        ? req.body.botlabelsku
        : Packaging.botlabelsku;
      Packaging.bottles = req.body.bottles
        ? req.body.bottles
        : Packaging.bottles;
      Packaging.boxname = req.body.boxname
        ? req.body.boxname
        : Packaging.boxname;
      Packaging.brand = req.body.brand ? req.body.brand : Packaging.brand;
      Packaging.brandSKU = req.body.brandSKU
        ? req.body.brandSKU
        : Packaging.brandSKU;
      Packaging.branded = req.body.branded
        ? req.body.branded
        : Packaging.branded;
      ...
      Packaging.customer = req.body.customer
        ? req.body.customer
        : Packaging.customer;
      Packaging.customerSKU = req.body.customerSKU
        ? req.body.customerSKU
        : Packaging.customerSKU;
      Packaging.fill = req.body.fill ? req.body.fill : Packaging.fill;
      Packaging.final_status = req.body.final_status
        ? req.body.final_status
        : Packaging.final_status;
      Packaging.flavour = req.body.flavour
        ? req.body.flavour
        : Packaging.flavour;
      Packaging.labeling_status = req.body.labeling_status
        ? req.body.labeling_status
        : Packaging.labeling_status;
      ...
      Packaging.mixing_status = req.body.mixing_status
        ? req.body.mixing_status
        : Packaging.mixing_status;
      Packaging.movedtoNext = req.body.movedtoNext
        ? req.body.movedtoNext
        : Packaging.movedtoNext;
      Packaging.orderID = req.body.orderID
        ? req.body.orderID
        : Packaging.orderID;
      Packaging.orderdate = req.body.orderdate
        ? req.body.orderdate
        : Packaging.orderdate;
      Packaging.packagingType = req.body.packagingType
        ? req.body.packagingType
        : Packaging.packagingType;
      Packaging.packaging_status = req.body.packaging_status
        ? req.body.packaging_status
        : Packaging.packaging_status;
      Packaging.packlabel = req.body.packlabel
        ? req.body.packlabel
        : Packaging.packlabel;
      Packaging.packlabelsku = req.body.packlabelsku
        ? req.body.packlabelsku
        : Packaging.packlabelsku;
      Packaging.premixed = req.body.premixed
        ? req.body.premixed
        : Packaging.premixed;
      Packaging.printing_status = req.body.printing_status
        ? req.body.printing_status
        : Packaging.printing_status;
      Packaging.productcode = req.body.productcode
        ? req.body.productcode
        : Packaging.productcode;
      Packaging.productdescription = req.body.productdescription
        ? req.body.productdescription
        : Packaging.productdescription;
      Packaging.recipe = req.body.recipe ? req.body.recipe : Packaging.recipe;
      Packaging.row = req.body.row ? req.body.row : Packaging.row;
      Packaging.starttime = req.body.starttime
        ? req.body.starttime
        : Packaging.starttime;
      Packaging.unbranded = req.body.unbranded
        ? req.body.unbranded
        : Packaging.unbranded;
      Packaging.userset = req.body.userset
        ? req.body.userset
        : Packaging.userset;
  ...
  remove: function(req, res) {
    ...
    var obj = {};
    obj[idenifiers.Packaging] = id;
    PackagingModel.findOneAndRemove(obj, function(err, Packaging) {
      if (err) {
        return res.status(500).json({
