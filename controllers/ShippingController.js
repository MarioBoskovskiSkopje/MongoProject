...
module.exports = {
    ...
    update: function (req, res) {
        ...
        ShippingModel.findOne({_id: id}, function (err, Shipping) {
            ...
            Shipping.AGrecipe = req.body.AGrecipe ? req.body.AGrecipe : Shipping.AGrecipe;
			Shipping.AGval = req.body.AGval ? req.body.AGval : Shipping.AGval;
			Shipping.backtubed = req.body.backtubed ? req.body.backtubed : Shipping.backtubed;
			Shipping.batch = req.body.batch ? req.body.batch : Shipping.batch;
			Shipping.botlabel = req.body.botlabel ? req.body.botlabel : Shipping.botlabel;
			Shipping.botlabelsku = req.body.botlabelsku ? req.body.botlabelsku : Shipping.botlabelsku;
			...
			Shipping.brandSKU = req.body.brandSKU ? req.body.brandSKU : Shipping.brandSKU;
			Shipping.bsize = req.body.bsize ? req.body.bsize : Shipping.bsize;
			Shipping.btype = req.body.btype ? req.body.btype : Shipping.btype;
			Shipping.CBDrecipe = req.body.CBDrecipe ? req.body.CBDrecipe : Shipping.CBDrecipe;
			Shipping.CBDvalue = req.body.CBDvalue ? req.body.CBDvalue : Shipping.CBDvalue;
			Shipping.coloredpremix = req.body.coloredpremix ? req.body.coloredpremix : Shipping.coloredpremix;
			Shipping.CompletionDate = req.body.CompletionDate ? req.body.CompletionDate : Shipping.CompletionDate;
			Shipping.customer = req.body.customer ? req.body.customer : Shipping.customer;
			Shipping.customerSKU = req.body.customerSKU ? req.body.customerSKU : Shipping.customerSKU;
			Shipping.dateshipped = req.body.dateshipped ? req.body.dateshipped : Shipping.dateshipped;
			Shipping.fill = req.body.fill ? req.body.fill : Shipping.fill;
			Shipping.final_status = req.body.final_status ? req.body.final_status : Shipping.final_status;
			Shipping.flavour = req.body.flavour ? req.body.flavour : Shipping.flavour;
			Shipping.flavrecipe = req.body.flavrecipe ? req.body.flavrecipe : Shipping.flavrecipe;
			Shipping.flavvalue = req.body.flavvalue ? req.body.flavvalue : Shipping.flavvalue;
			Shipping.labeling_status = req.body.labeling_status ? req.body.labeling_status : Shipping.labeling_status;
			Shipping.lid = req.body.lid ? req.body.lid : Shipping.lid;
			Shipping.lidSKU = req.body.lidSKU ? req.body.lidSKU : Shipping.lidSKU;
			Shipping.MCTrecipe = req.body.MCTrecipe ? req.body.MCTrecipe : Shipping.MCTrecipe;
			...
			Shipping.mixing_status = req.body.mixing_status ? req.body.mixing_status : Shipping.mixing_status;
			Shipping.NIB = req.body.NIB ? req.body.NIB : Shipping.NIB;
			Shipping.Nico = req.body.Nico ? req.body.Nico : Shipping.Nico;
			Shipping.Nicotrecipe = req.body.Nicotrecipe ? req.body.Nicotrecipe : Shipping.Nicotrecipe;
			Shipping.Nicotrecipesalts = req.body.Nicotrecipesalts ? req.body.Nicotrecipesalts : Shipping.Nicotrecipesalts;
			Shipping.orderdate = req.body.orderdate ? req.body.orderdate : Shipping.orderdate;
			Shipping.orderID = req.body.orderID ? req.body.orderID : Shipping.orderID;
			Shipping.packaging_status = req.body.packaging_status ? req.body.packaging_status : Shipping.packaging_status;
			Shipping.packagingType = req.body.packagingType ? req.body.packagingType : Shipping.packagingType;
			Shipping.packlabel = req.body.packlabel ? req.body.packlabel : Shipping.packlabel;
			Shipping.packlabelsku = req.body.packlabelsku ? req.body.packlabelsku : Shipping.packlabelsku;
			Shipping.partialPackaging = req.body.partialPackaging ? req.body.partialPackaging : Shipping.partialPackaging;
			Shipping.partialProduction = req.body.partialProduction ? req.body.partialProduction : Shipping.partialProduction;
			Shipping.PGrecipe = req.body.PGrecipe ? req.body.PGrecipe : Shipping.PGrecipe;
			...
			Shipping.premixed = req.body.premixed ? req.body.premixed : Shipping.premixed;
			Shipping.PRINTCODE = req.body.PRINTCODE ? req.body.PRINTCODE : Shipping.PRINTCODE;
			Shipping.printing_status = req.body.printing_status ? req.body.printing_status : Shipping.printing_status;
			Shipping.priority = req.body.priority ? req.body.priority : Shipping.priority;
			Shipping.productcode = req.body.productcode ? req.body.productcode : Shipping.productcode;
			Shipping.productdescription = req.body.productdescription ? req.body.productdescription : Shipping.productdescription;
			Shipping.production_status = req.body.production_status ? req.body.production_status : Shipping.production_status;
			Shipping.QTY = req.body.QTY ? req.body.QTY : Shipping.QTY;
			Shipping.recipe = req.body.recipe ? req.body.recipe : Shipping.recipe;
			Shipping.removedPackaging = req.body.removedPackaging ? req.body.removedPackaging : Shipping.removedPackaging;
			Shipping.removeProduction = req.body.removeProduction ? req.body.removeProduction : Shipping.removeProduction;
			...
			Shipping.shipping_status = req.body.shipping_status ? req.body.shipping_status : Shipping.shipping_status;
			Shipping.SHIPPINGCODE = req.body.SHIPPINGCODE ? req.body.SHIPPINGCODE : Shipping.SHIPPINGCODE;
			Shipping.stocking = req.body.stocking ? req.body.stocking : Shipping.stocking;
			Shipping.unbranded = req.body.unbranded ? req.body.unbranded : Shipping.unbranded;
			Shipping.userset = req.body.userset ? req.body.userset : Shipping.userset;
			Shipping.VGrecipe = req.body.VGrecipe ? req.body.VGrecipe : Shipping.VGrecipe;
			Shipping.VGval = req.body.VGval ? req.body.VGval : Shipping.VGval;
			Shipping.wentNegative = req.body.wentNegative ? req.body.wentNegative : Shipping.wentNegative;
